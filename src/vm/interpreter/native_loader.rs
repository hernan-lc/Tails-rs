    ...
    let proto_idx = gc.allocate(
        ...
        HeapValue::Object(JsObject {
            properties: props! {
                ...
                "eventNames" => Value::NativeFunction(c::EVENT_EMITTER_EVENT_NAMES),
                "getMaxListeners" => Value::NativeFunction(c::EVENT_EMITTER_GET_MAX_LISTENERS),
                "setMaxListeners" => Value::NativeFunction(c::EVENT_EMITTER_SET_MAX_LISTENERS),
                "prependListener" => Value::NativeFunction(c::EVENT_EMITTER_PREPEND_LISTENER),
                "prependOnceListener" => Value::NativeFunction(c::EVENT_EMITTER_PREPEND_ONCE_LISTENER),
            },
            prototype: None,
            extensible: true,
        }),
