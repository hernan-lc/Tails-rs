...
mod validator {
    ...
    pub fn stringMin(min: f64) -> NativeValue {
        <Value as ToNativeValue>::to_native_value(&serde_json::json!({"type":"string","minLength":min as usize})).unwrap()
    }

    #[tails_function]
    #[allow(non_snake_case)]
    pub fn stringMax(max: f64) -> NativeValue {
        <Value as ToNativeValue>::to_native_value(&serde_json::json!({"type":"string","maxLength":max as usize})).unwrap()
    }
    ...
    pub fn stringLength(len: f64) -> NativeValue {
        let v = len as usize;
        <Value as ToNativeValue>::to_native_value(&serde_json::json!({"type":"string","minLength":v,"maxLength":v})).unwrap()
    }

    #[tails_function]
    #[allow(non_snake_case)]
    pub fn stringPattern(pattern: String) -> NativeValue {
        <Value as ToNativeValue>::to_native_value(&serde_json::json!({"type":"string","pattern":pattern})).unwrap()
    }

    #[tails_function]
    #[allow(non_snake_case)]
    pub fn stringEmail() -> NativeValue {
        <Value as ToNativeValue>::to_native_value(&serde_json::json!({"type":"string","format":"email"})).unwrap()
    }

    #[tails_function]
    #[allow(non_snake_case)]
    pub fn stringUrl() -> NativeValue {
        <Value as ToNativeValue>::to_native_value(&serde_json::json!({"type":"string","format":"url"})).unwrap()
    }

    #[tails_function]
    #[allow(non_snake_case)]
    pub fn stringUuid() -> NativeValue {
        <Value as ToNativeValue>::to_native_value(&serde_json::json!({"type":"string","format":"uuid"})).unwrap()
    }

    #[tails_function]
    #[allow(non_snake_case)]
    pub fn stringDatetime() -> NativeValue {
        <Value as ToNativeValue>::to_native_value(&serde_json::json!({"type":"string","format":"datetime"})).unwrap()
    }

    #[tails_function]
    #[allow(non_snake_case)]
    pub fn stringIPv4() -> NativeValue {
        <Value as ToNativeValue>::to_native_value(&serde_json::json!({"type":"string","format":"ipv4"})).unwrap()
    }

    #[tails_function]
    #[allow(non_snake_case)]
    pub fn stringIPv6() -> NativeValue {
        <Value as ToNativeValue>::to_native_value(&serde_json::json!({"type":"string","format":"ipv6"})).unwrap()
    }

    #[tails_function]
    #[allow(non_snake_case)]
    pub fn stringPhone() -> NativeValue {
        <Value as ToNativeValue>::to_native_value(&serde_json::json!({"type":"string","format":"phone"})).unwrap()
    }

    #[tails_function]
    #[allow(non_snake_case)]
    pub fn stringBase64() -> NativeValue {
        <Value as ToNativeValue>::to_native_value(&serde_json::json!({"type":"string","format":"base64"})).unwrap()
    }
    ...
    pub fn numberMin(min: f64) -> NativeValue {
        <Value as ToNativeValue>::to_native_value(&serde_json::json!({"type":"number","min":min})).unwrap()
    }

    #[tails_function]
    #[allow(non_snake_case)]
    pub fn numberMax(max: f64) -> NativeValue {
        <Value as ToNativeValue>::to_native_value(&serde_json::json!({"type":"number","max":max})).unwrap()
    }

    #[tails_function]
    #[allow(non_snake_case)]
    pub fn numberInt() -> NativeValue {
        <Value as ToNativeValue>::to_native_value(&serde_json::json!({"type":"number","integer":true})).unwrap()
    }

    #[tails_function]
    #[allow(non_snake_case)]
    pub fn numberPositive() -> NativeValue {
        <Value as ToNativeValue>::to_native_value(&serde_json::json!({"type":"number","positive":true})).unwrap()
    }

    #[tails_function]
    #[allow(non_snake_case)]
    pub fn numberNegative() -> NativeValue {
        <Value as ToNativeValue>::to_native_value(&serde_json::json!({"type":"number","negative":true})).unwrap()
    }

    #[tails_function]
    #[allow(non_snake_case)]
    pub fn numberMultipleOf(n: f64) -> NativeValue {
        <Value as ToNativeValue>::to_native_value(&serde_json::json!({"type":"number","multipleOf":n})).unwrap()
    }

    #[tails_function]
    #[allow(non_snake_case)]
    pub fn numberFinite() -> NativeValue {
        <Value as ToNativeValue>::to_native_value(&serde_json::json!({"type":"number","finite":true})).unwrap()
    }
    ...
    pub fn arrayMin(itemsSchema: NativeValue, min: f64) -> NativeValue {
        ...
        <Value as ToNativeValue>::to_native_value(&serde_json::json!({"type":"array","items":items,"minLength":min as usize})).unwrap()
    }
    ...
    pub fn arrayMax(itemsSchema: NativeValue, max: f64) -> NativeValue {
        let items: Value = Value::from_native_value(itemsSchema).unwrap_or_default();
        <Value as ToNativeValue>::to_native_value(&serde_json::json!({"type":"array","items":items,"maxLength":max as usize})).unwrap()
    }
    ...
    pub fn arrayLength(itemsSchema: NativeValue, len: f64) -> NativeValue {
        let items: Value = Value::from_native_value(itemsSchema).unwrap_or_default();
        let v = len as usize;
        <Value as ToNativeValue>::to_native_value(&serde_json::json!({"type":"array","items":items,"minLength":v,"maxLength":v})).unwrap()
    }
    ...
    pub fn arrayUnique(itemsSchema: NativeValue) -> NativeValue {
        let items: Value = Value::from_native_value(itemsSchema).unwrap_or_default();
        <Value as ToNativeValue>::to_native_value(&serde_json::json!({"type":"array","items":items,"uniqueItems":true})).unwrap()
    }
    ...
    pub fn optional(innerSchema: NativeValue) -> NativeValue {
        ...
        <Value as ToNativeValue>::to_native_value(&serde_json::json!({"type":"optional","inner":inner})).unwrap()
    }
    ...
    pub fn nullable(innerSchema: NativeValue) -> NativeValue {
        let inner: Value = Value::from_native_value(innerSchema).unwrap_or_default();
        <Value as ToNativeValue>::to_native_value(&serde_json::json!({"type":"nullable","inner":inner})).unwrap()
    }
    ...
    pub fn transform(innerSchema: NativeValue, transformName: String) -> NativeValue {
        let inner: Value = Value::from_native_value(innerSchema).unwrap_or_default();
        <Value as ToNativeValue>::to_native_value(&serde_json::json!({"type":"transform","inner":inner,"transform":transformName})).unwrap()
    }
    ...
    pub fn refine(innerSchema: NativeValue, message: String) -> NativeValue {
        let inner: Value = Value::from_native_value(innerSchema).unwrap_or_default();
        <Value as ToNativeValue>::to_native_value(&serde_json::json!({"type":"refine","inner":inner,"message":message})).unwrap()
    }
    ...
    pub fn pipe(schemas: NativeValue) -> NativeValue {
        ...
        <Value as ToNativeValue>::to_native_value(&serde_json::json!({"type":"pipeline","schemas":schemas_arr})).unwrap()
    }
    ...
    pub fn preprocess(transformName: String, innerSchema: NativeValue) -> NativeValue {
        let inner: Value = Value::from_native_value(innerSchema).unwrap_or_default();
        <Value as ToNativeValue>::to_native_value(&serde_json::json!({"type":"preprocess","transform":transformName,"inner":inner})).unwrap()
    }
    ...
    pub fn withDefault(innerSchema: NativeValue, defaultValue: NativeValue) -> NativeValue {
        ...
        <Value as ToNativeValue>::to_native_value(&serde_json::json!({"type":"default","inner":inner,"default":default})).unwrap()
    }
    ...
    pub fn customError(innerSchema: NativeValue, message: String) -> NativeValue {
        ...
        if let Some(obj) = inner.as_object_mut() {
            obj.insert("customError".to_string(), serde_json::Value::String(message));
        }
    ...
    pub fn lazy(id: String, innerSchema: NativeValue) -> NativeValue {
        ...
        <Value as ToNativeValue>::to_native_value(&serde_json::json!({"type":"lazy","id":id,"schema":schema})).unwrap()
    }
    ...
    pub fn literal(value: NativeValue) -> NativeValue {
        ...
        <Value as ToNativeValue>::to_native_value(&serde_json::json!({"type":"literal","value":val})).unwrap()
    }
    ...
    pub fn enumValues(values: NativeValue) -> NativeValue {
        ...
        <Value as ToNativeValue>::to_native_value(&serde_json::json!({"type":"enum","values":arr})).unwrap()
    }
    ...
    pub fn record(valuesSchema: NativeValue) -> NativeValue {
        ...
        <Value as ToNativeValue>::to_native_value(&serde_json::json!({"type":"record","values":values})).unwrap()
    }
    ...
    pub fn union(schemas: NativeValue) -> NativeValue {
        let schemas_val: Value = Value::from_native_value(schemas).unwrap_or_default();
        let schemas_arr = schemas_val.as_array().cloned().unwrap_or_default();
        <Value as ToNativeValue>::to_native_value(&serde_json::json!({"type":"union","schemas":schemas_arr})).unwrap()
    }
    ...
    pub fn intersection(schemas: NativeValue) -> NativeValue {
        let schemas_val: Value = Value::from_native_value(schemas).unwrap_or_default();
        let schemas_arr = schemas_val.as_array().cloned().unwrap_or_default();
        <Value as ToNativeValue>::to_native_value(&serde_json::json!({"type":"intersection","schemas":schemas_arr})).unwrap()
    }
    ...
    pub fn tuple(schemas: NativeValue) -> NativeValue {
        let schemas_val: Value = Value::from_native_value(schemas).unwrap_or_default();
        let schemas_arr = schemas_val.as_array().cloned().unwrap_or_default();
        <Value as ToNativeValue>::to_native_value(&serde_json::json!({"type":"tuple","schemas":schemas_arr})).unwrap()
    }
    ...
    pub fn coerce(target: String, innerSchema: NativeValue) -> NativeValue {
        let inner: Value = Value::from_native_value(innerSchema).unwrap_or_default();
        <Value as ToNativeValue>::to_native_value(&serde_json::json!({"type":"coerce","target":target,"inner":inner})).unwrap()
    }
}
